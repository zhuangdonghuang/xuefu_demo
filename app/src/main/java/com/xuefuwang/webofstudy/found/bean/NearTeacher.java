 ...
 */
public class NearTeacher {

    /**
     *
     * 我们在Android开发中使用Bean类最多的场景是从网络获取数据，将数据以Bean类组织，Bean类中的数据
     * 用于填充UI界面中的控件。此处使用Bean类主要是组织数据方便，便于将其中的数据填充到控件中。
     *
     * TeacherID : 602
    ...
    public static NearTeacher objectFromData(String str) {

        return new Gson().fromJson(str, NearTeacher.class);
    }

    public static List<NearTeacher> arrayNearTeacherFromData(String str) {

        Type listType = new TypeToken<ArrayList<NearTeacher>>() {
        }.getType();
