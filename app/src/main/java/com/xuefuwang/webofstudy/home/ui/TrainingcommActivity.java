 ...
 */
public class TrainingcommActivity extends FragmentActivity{
   ...
   // private TabFragment[] mFragments = new TabFragment[mTitles.length];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainingconm);
    ...
    private void initDatas()
    {
     ...
     /*   IntroduceFragmentPx introduceFragment = new IntroduceFragmentPx();
        CourseFragmentPx courseFragment = new CourseFragmentPx();
        CommentFragmentPx commentFragement = new CommentFragmentPx();

        List<Fragment>  list = new ArrayList<>();
        list.add(introduceFragment);
        list.add(courseFragment);
        list.add(commentFragement);
    ...
    private void initViews()
    {
        ...
        imageLoader = ImageLoader.getInstance(TrainingcommActivity.this);
        list = new ArrayList<>();
    ...
    private void setFragment() {
        ...
        IntroduceFragmentPx introduceFragmentPx = new IntroduceFragmentPx();
        bundle = new Bundle();
        bundle.putInt("id",id);
        introduceFragmentPx.setArguments(bundle);
        list.add(introduceFragmentPx);

        CourseFragmentPx courseFragmentPx = new CourseFragmentPx();
        list.add(courseFragmentPx);

        CommentFragmentPx commentFragmentPx = new CommentFragmentPx();
        list.add(commentFragmentPx);
