...
public class Trainningcomm {
     ...
     * HonorName : 专业证书
     * IsApproval_hr : 2
     * HonorLink : files/doctorhuang/2015-09-28/p1a092881r1jka1gm21ef11m8uhf61.png
     * GetHonorDate : 2015-09-28T12:09:31
     * LookCount : 1773
     * StuCount : 3
     * CourseCount : 5
     * Commpercent : 100
    ...
    public static Trainningcomm objectFromData(String str) {

        return new Gson().fromJson(str, Trainningcomm.class);
    }

    public static List<Trainningcomm> arrayTrainningcommFromData(String str) {

        java.lang.reflect.Type listType = new TypeToken<ArrayList<Trainningcomm>>() {
        }.getType();
    ...
    public int getIsApproval_hr() {
        return IsApproval_hr;
    }

    public void setIsApproval_hr(int IsApproval_hr) {
        this.IsApproval_hr = IsApproval_hr;
    }
    ...
    public void setGetHonorDate(String GetHonorDate) {
        this.GetHonorDate = GetHonorDate;
    }
