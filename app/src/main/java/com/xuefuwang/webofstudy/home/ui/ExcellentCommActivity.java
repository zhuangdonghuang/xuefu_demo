 ...
 */
public class ExcellentCommActivity extends FragmentActivity{
   ...
   // private TabFragment[] mFragments = new TabFragment[mTitles.length];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_excellentcomm);
    ...
    private void initViews()
    {
        ...
        imageLoader = ImageLoader.getInstance(ExcellentCommActivity.this);
        list = new ArrayList<>();
...
//                    tvrc.setText(stringBuilder); //风格
    ...
    private void setFragment() {
        ...
        IntroduceFragmentPy introduceFragmentPy  = new IntroduceFragmentPy();
        bundle = new Bundle();
        bundle.putInt("id",id);
        introduceFragmentPy.setArguments(bundle);
        list.add(introduceFragmentPy);

        CourseFragmentPy courseFragmentPy = new CourseFragmentPy();
        list.add(courseFragmentPy);

        CommentFragmentPy commentFragmentPy = new CommentFragmentPy();
        list.add(commentFragmentPy);
