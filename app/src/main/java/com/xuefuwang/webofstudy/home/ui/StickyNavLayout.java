...
public class StickyNavLayout extends LinearLayout {
    ...
    /**
     * 自定义的LinearLayout中，需要判断y方向的，所以down的时候记录下y的值，然后move的时候拿到dy
     * 得到v方向的velocityY，调用fling进行移动
     * @param event
     * @return
     */
    ...
    /**
     * 重写computeScroll方法，在里面判断scroller是否结束，
     * 如果没有，则scrollTo一下，最后记得invalidate
     * @param velocityY
     */
    ...
    /**
     * StickyNavLayout内部有一个ScrollView，
     * 那么根据事件的转发机制，这个内部的ScrollView肯定会处理上下拖动这种情况的，
     * 事件会被它拦截
     */
